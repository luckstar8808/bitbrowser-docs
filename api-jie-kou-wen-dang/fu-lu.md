...
各平台的webgl厂商不同，需要根据ua的系统平台去选择，具体如下：

```
windows：['Google Inc.']
mac：['Intel Inc.', 'ATI Technologies Inc.', 'Apple Inc.', 'Apple']
linux：['Google Inc.']
android: ['Qualcomm', 'ARM']
ios:['Apple Inc.']
```
...
```
{
  ...
  'ATI Technologies Inc.': [
    ...
    'AMD Radeon Pro 5500 XT OpenGL Engine',
    ...
    'AMD Radeon RX 570 OpenGL Engine',
    'AMD Radeon R9 M390 OpenGL Engine',
    'AMD Radeon Pro 575X OpenGL Engine',
    ...
    'AMD Radeon RX 590 OpenGL Engine'
  ],
  'Apple Inc.': ['Apple GPU'],
  Apple: ['Apple M1'],
  Qualcomm: [
  ...
  ARM: ['Mali-G76', 'Mali-G52', 'Mali-T880', 'Mali-G72']
}
```
...
```
[1, 2, 3, 4, 5, 8, 12, 15, 16, 18, 24, 30, 32, 48]
```
...
// 从下方列表中随机几个设置，示例：
{
  ...
  speechVoicesValue: '[{"is_remote":true,"voice_uri":"Google 普通话（中国大陆）","name":"Google 普通话（中国大陆）","lang":"zh-CN"},{"is_remote":true,"voice_uri":"Google 粤語（香港）","name":"Google 粤語（香港）","lang":"zh-HK"}]'
}
...
### 媒体设备 mediaDeviceValue 参考值

```
// 每一个项目为一个对象，如下：
{
    device_id: 'f4mgavrqhvs0alzcot008c792xg5coi8ulp85aga0jafhpmd6vqym02f18rdmi81', // 随机64位字符串
    group_id: 'qnvptjh67j1p9xnz3qri6evw8pld9d9nyb1bs87tb10g767wwmkihn8mz79nkq6k', // 随机64位字符串
    label: 'FaceTime HD Camera' // 从以下参考值中随机使用一个
}
// label 参考值
[
"FaceTime HD Camera",
"Integrated Camera (07C7:58327)",
"Integrated Camera (01F0:6031)",
"Integrated Camera (051B:55604)",
"Integrated Camera (0EF1:54561)",
"Integrated Camera (0E9B:17517)",
"Integrated Camera (07F0:24902)"
]
// 组合完毕后，序列化为字符串传给 mediaDeviceValue，如
{
...// 其他属性
mediaDeviceValue: "[{\"device_id\":\"f4mgavrqhvs0alzcot008c792xg5coi8ulp85aga0jafhpmd6vqym02f18rdmi81\",\"group_id\":\"qnvptjh67j1p9xnz3qri6evw8pld9d9nyb1bs87tb10g767wwmkihn8mz79nkq6k\",\"label\":\"Integrated Camera (07C7:58327)\"},{\"device_id\":\"prs9cw5ac8ud6y3rdz9yrh9tgnw1m85hh7jver6c6nx75kmqn0yytnj1b6wjf3q4\",\"group_id\":\"hmoz50vyb5q3szivu8pgyddirakyo16ygrqbv0d31suk4e7m2z1vblfsss84otv3\",\"label\":\"Integrated Camera (07C7:58327)\"},{\"device_id\":\"g2akezp5gehmro2301sr8eb3uyjrjvqszcs9jx6v4pvzrfhe4gkilkp0jfcv8fsq\",\"group_id\":\"isr1kj25mshutcdwd3zrqmma2imc4h7ac2feakmu39f4bksh02nsxs0wd11k2pw6\",\"label\":\"Integrated Camera (07C7:58327)\"}]"
}
```
...
// 随机从下方列表中选择几项设置，示例如下：
{
  ...
  disableSslCipherSuites: '[{"label":"TLS_AES_128_CCM_8_SHA256","value":"0x1305"},{"label":"TLS_AES_128_CCM_SHA256","value":"0x1304"}]', // ssl 禁用特性，序列化的ssl特性值，参考附录
}
